...
describe('varint', () => {
  ...
  describe('prepend', () => {
    it('should prepend one integer as varint to a Uint8Array', async () => {
      const bytes = new TextEncoder().encode('foobar');
      const int = 42;
    ...
    it('should prepend one integer bigger than 128 as varint to a Uint8Array', async () => {
      const bytes = new TextEncoder().encode('foobar');
      const int = 128;
    ...
    it('should prepend multiple integers as varints to a Uint8Array', async () => {
      const bytes = new TextEncoder().encode('foobar');
      const int = [42, 128, 110];
